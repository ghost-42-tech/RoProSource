...
var wishlistHTML = `<div class="container-header">
	<h3>RoPro Trade Offers <img class="offers-icon-big" style="height:15px;margin-bottom:0px;margin-left:5px;" src="https://ropro.io/images/offers_icon.svg"></h3>
	  <button id="createOfferButton" type="button" class="btn-fixed-width-lg btn-growth-lg" style="background-color:#0084dd;border:0px;font-size:18px;padding:5px;float:right;">Create Offer</button>
   </div>
   <resellers-pane class="ng-isolate-scope">
		<ul id="wishlistOffers" class="vlist">
			
		</ul>
		<div id="seemore_wishlist" style="display:none;" class="ajax-comments-more-button-container" itemid="387256603" page="0">
                <button type="button" class="btn-control-sm rbx-comments-see-more">See More</button>
            </div>
   </resellers-pane>`
var myInventory = -1
...
function fetchWishlist(itemID, page) {
	return new Promise(resolve => {
		chrome.runtime.sendMessage({greeting: "GetURL", url:"https://ropro.io/api/getWishlist.php?id=" + itemID + "&page=" + page}, 
			function(data) {
				resolve(data)
			}
		)
...
function refreshWishlist() {
	...
	getWishes(parseInt(seeMoreWishlist.getAttribute("itemid")), 0)
}
...
<div style="position:relative;">
	...
	<p value="${value}" class="wantvalue ng-scope ng-isolate-scope" style="font-weight:bold;font-size:25px;margin-top:25px;text-align:center;class=" ng-scope="">+${kFormatter(value)}<br>Value</p>
	</span>
</div>
`
...
async function createOffer(userid, username, posted, note) {
offerElement = document.createElement('li')
offerElement.setAttribute("class", "reseller-item list-item offerlist_item")
offerElement.setAttribute("style", "margin-top:0px;padding-top:5px;padding-bottom:5px;margin-bottom:30px;")
note = stripTags(note)
offerHTML = `
   <div style="position:relative;height:125px;" class="resale-info">
	   ...
	   <div style="position:absolute;left:575px;bottom:0px;font-size:12px;" class="wantitemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
	   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
	   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
		...
		<span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
		<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
		<div style="position:absolute;left:575px;bottom:-18px;font-size:12px;" class="wantitemvalue"><div style="margin-top:-5px;display: inline-block;">
	   ...
	   <div style="margin-right:5px;" class="reseller-price-container"> 	   <div style="position:absolute;left:530px;top:0px;width:175px;">
		  ...
		  <p class="simplebar-content-wrapper item-card-thumb-container ng-isolate-scope thumbnail-2d-container" style="overflow-y:auto;margin-top:7px;padding:10px;height:70px;width:120px;font-size:12px;">
		   ...
		   <button style="position:absolute;left:865px;top:30px;height:50px;" class="reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="window.open('https://www.roblox.com/users/${parseInt(userid)}/trade', '_blank')">Trade</button>
   </div>
   `
...
function updateOfferBuilder() {
	...
	editor.getElementsByClassName('itemrap')[0].getElementsByClassName('total-value')[0].innerHTML = offerBuilderRap <= 0 ? "---" : addCommas(offerBuilderRap)
	editor.getElementsByClassName('itemvalue')[0].getElementsByClassName('total-value')[0].innerHTML = offerBuilderValue <= 0 ? "---" : addCommas(offerBuilderValue)
	editor.getElementsByClassName('wantitemrap')[0].getElementsByClassName('total-value')[0].innerHTML = offerBuilderWantRap <= 0 ? "---" : addCommas(offerBuilderWantRap  + valueAmount)
	editor.getElementsByClassName('wantitemvalue')[0].getElementsByClassName('total-value')[0].innerHTML = offerBuilderWantValue <= 0 ? "---" : addCommas(offerBuilderWantValue + valueAmount)
}
...
offerElement.setAttribute("style", "margin-top:0px;padding-top:5px;padding-bottom:5px;position:relative;")
offerHTML = `
   <a class="list-header reseller-item-avatar" ng-href="https://www.roblox.com/users/${parseInt(userid)}/profile" href="https://www.roblox.com/users/${parseInt(userid)}/profile">
         <div style="margin:auto;" class="user_div">
			<span>
   ...
   <div style="position:absolute;left:295px;bottom:7px;font-size:12px;" class="itemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="position:absolute;left:295px;bottom:-11px;font-size:12px;" class="itemvalue"><div style="margin-top:-5px;display: inline-block;">
   <img style="width:10px;margin-left:4px;" src="https://ropro.io/images/ropro_icon_small.png">
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="display:none;position:absolute;left:580px;bottom:7px;font-size:12px;" class="wantitemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
	<span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
	<div style="display:none;position:absolute;left:580px;bottom:-11px;font-size:12px;" class="wantitemvalue"><div style="margin-top:-5px;display: inline-block;">
	<img style="width:10px;margin-left:4px;" src="https://ropro.io/images/ropro_icon_small.png">
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="margin-top:-10px;" class="resale-info">
	   ...
	   <div style="margin-right:5px;" class="reseller-price-container"> 	   <div style="position:absolute;left:530px;top:0px;width:175px;">
		...
		<div style="position:absolute;left:720px;top:0px;width:120px;">
	      ...
	      <button id="postOfferButton" style="background-color:#0084dd;position:absolute;left:865px;top:30px;height:50px;" class="reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Post</button>
   </div>
   `
offerElement.innerHTML += offerHTML
return offerElement
...
function insertItem(elem) {
	containers = [document.getElementById('itemContainer1'), document.getElementById('itemContainer2'), document.getElementById('itemContainer3'), document.getElementById('itemContainer4')]
	inserted = false
	for (i = 0; i < containers.length; i++) {
		container = containers[i]
		if (container.getAttribute("itemid") == -1) {
			container.setAttribute("itemid", parseInt(elem.getAttribute("itemID")))
			if (container.id != "itemContainer5") {
...
async function populateInventory(search) {
	...
	for (item in myInventory) {
		...
		if (valid == true) {
			...
			if (myItem['quantity'] - count > 0) {
				newItem = createInventoryItem(myItem['assetId'], myItem['name'], myInventoryItemInfo[myItem['assetId']]['rap'], myInventoryItemInfo[myItem['assetId']]['value'], myItem['quantity'] - count)
...
async function createInventory(container) {
	$("#inventorySelector").remove()
	...
	inventoryHTML = `<span style="width:200px;font-weight:bold;font-size:23px;float:left;" class="border-bottom item-name-container">My Inventory</span><div style="padding-top:0px;margin-top:0px;position:absolute;top:65px;width:270px;height:320px;" class="content"><div id="searchItem" style="margin-top:15px;height:45px;position:relative;">
					<div style="width:260px;margin-left:5px;margin-top:-7px;margin-bottom:0px;" class="input-group"><form><input autofocus id="searchInventory" class="form-control input-field" type="text" placeholder="Search" maxlength="120" autocomplete="off" value=""></form><div class="input-group-btn"><button style="margin:0px;margin-left:2px;" id="navbar-search-btn" class="input-addon-btn" type="submit"><span class="icon-nav-search"></span></button></div></div>
						</div><ul id="inventoryList" class="inventoryList" style="width:283px;height:265px;overflow-y:auto;position:relative;" id="inventoryList">
					</ul></div>`
	...
	$("#searchInventory").on('input', function(){
		populateInventory($("#searchInventory").val())
	})
...
async function createWish(json) {
	wishNote = stripTags(json.note)
	userId = json.user
	posted = json.posted
	username = json.username
	offers = document.getElementById("wishlistOffers")
	offer = await createOffer(userId, username, posted, wishNote)
...
async function getWishes(wantID, wishPage) {
	wishlist = await fetchWishlist(wantID, wishPage)
	...
	if (wishlist['valid'] == true) {
		if (wishlist['none'] == false) {
			...
			document.getElementById('wishlistOffers').innerHTML = '<p style="margin-left:20px;margin-bottom:30px;">No trade offers for this item... Be the first to post one!</p>'
		}
	} else {
...
function wishlistMain() {
	...
	insertAfter(wishlist, document.getElementById('resellers'))
	...
	seeMoreWishlist = document.getElementById('seemore_wishlist')
	seeMoreWishlist.setAttribute('itemid', parseInt(itemID))
	seeMoreWishlist.addEventListener("click", function(){
		getWishes(parseInt(seeMoreWishlist.getAttribute("itemid")), parseInt(seeMoreWishlist.getAttribute("page")))
	});
	...
	createOfferButton.addEventListener("click", async function(){
		if (createOfferButton.innerHTML == "Create Offer") {
			...
			container1.addEventListener("click", function(){ addItem(this) })
			...
			container2.addEventListener("click", function(){ addItem(this) })
			...
			container3.addEventListener("click", function(){ addItem(this) })
			...
			container4.addEventListener("click", function(){ addItem(this) })
			...
			container5.setAttribute("itemid", parseInt(pageItemID))
			leaveItem(container5)
...
async function doMain() {
	...
	setTimeout(async function() {
		try{
			resellersClass = document.getElementById('resellers').getAttribute("class")
			if (await fetchSetting("tradeOffersSection")) {
				wishlistMain()
			}
		}catch{
			doMain()
